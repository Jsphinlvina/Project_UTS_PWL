    ...
    <div class="offcanvas-md offcanvas-end " tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body nav-background d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            <ul class="nav flex-column">
                ...
                @can('kaprodi')
                    <li class="nav-item">
                        <a class="nav-link d-flex align-items-center gap-2 {{Request::is('dashboard/matakuliah') ? 'active': ''}}"
                ...
                @endcan
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2 {{Request::is('dashboard/polling')? 'active': ''}}"
